...
## Goals
  The goal of this project is to display a solid understanding of how utilize API's display relevant data implemented via javascript. This project provided only a desktop mockup, leaving the design and development of the layout for screen sizes relevant to mobile and tablet devices on the student.
